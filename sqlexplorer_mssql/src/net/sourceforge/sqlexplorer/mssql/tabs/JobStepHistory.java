...
public class JobStepHistory extends AbstractSQLTab {
	...
	public String getLabelText() {
		return Messages.getString("mssql.dbdetail.tab.jobstephistory");
	}
	...
	public Object[] getSQLParameters() {
		return new Object[] { ((JobsNode)getNode().getParent()).getID(),
				((JobNodeStep)getNode()).getID() };
	}

	public String getStatusMessage() {
		return Messages.getString("mssql.dbdetail.tab.jobsStepHistoryFor") + " " + getNode().getName();
	}
}
